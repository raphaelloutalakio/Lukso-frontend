...
export interface ERAHomiNftInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "authorizeOperator"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "mintNewEraHomi",
...
export interface ERAHomiNft extends BaseContract {
  connect(runner?: ContractRunner | null): ERAHomiNft;
  waitForDeployment(): Promise<this>;

  interface: ERAHomiNftInterface;
  ...
  mintNewEraHomi: TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, allowNonLSP1Recipient: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "mintNewEraHomi"
  ): TypedContractMethod<
    [to: AddressLike, amount: BigNumberish, allowNonLSP1Recipient: boolean],
    [void],
    "nonpayable"
